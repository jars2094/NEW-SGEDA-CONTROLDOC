...
{
    public partial class ModalImportTDR_TVD: ComponentBase
    {
        #region Injects
        ...
        private async Task HandleValidSubmit()
        {
            ...
            Console.WriteLine("bandeja de anulacion Guardado");
        ...
        public void UpdateModalStatusImport(bool newValue)
        {
        ...
        private void HandleModalNotiClose(ModalClosedEventArgs args)
        {
            ...
            {
                UpdateModalStatusImport(args.ModalStatus);
            }
